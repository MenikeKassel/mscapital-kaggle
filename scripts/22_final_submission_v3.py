# -*- coding: utf-8 -*-
"""
Final v3: Temporal 权重提交 (P0 科研验证)
权重 (lgb 0.2, cat 0.5, mlp 0.3) 来自 temporal folds 平均优化, Pseudo-LB38 验证 +0.0009
构成: LGBM + CatBoost + MLP-ens 全量训练
"""
import time
import random
import numpy as np
...
N_THREADS = 12
OUT = r"D:\mscapital-kaggle\output\submissions\submission_blend_v3.csv"
