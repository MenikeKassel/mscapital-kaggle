...
提交: **v1 0.122** (#79, 来自 G3) → v2 0.122 (H1) → v3 0.122 (P0-03) → **v4 0.123** (SUB-v4) — 完整登记在 [submissions/README.md](../submissions/README.md)
...
提交: **v4 0.123** (SUB-v4, R2+temporal, 科研闭环验证成功)
...
提交: **v5 0.125** (SUB-v5, R2+22微观) → **v6 0.082** (TCN, N005 灾难) → **v7 0.135** (SUB-v7, RealMLP 复刻 0.8/0.2) → **v8a 0.139** → **v8b 0.142** (SUB-v8, #30, +lb142 0.5/0.5)
