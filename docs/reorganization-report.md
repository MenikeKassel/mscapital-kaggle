...
**编号体系 (2026-08-15 统一, 消除历史重名)**: `P{n}-{NN}{后缀}` 正式实验 (P0-01, P1-01, P5-02, P6R-00, P7-01) · 早期表格保留字母序号 (A1~H1), 重名/易混加消歧后缀 (**B1-LGO** vs B1 官方基线, **C1-FE** vs C-01 Clean-RealMLP, **E1-TW** vs E-01) · 提交事件独立命名空间 **S-04/5/7/8** (与 submissions/README.md 对应) · plan 方案名 (P5-02M/B-lite v2/RICS) 与实际执行 ID (P5-03~E) 映射见 P5_market README · 历史编号全部保留在 registry/README 的 **Alias** 列。
