...
| R03-micro-primitives | frozen | 4 | micro features absorbed into frozen asset | R04-realmlp-clean |
| R04-realmlp-clean | frozen | 5 | Clean Baseline v2 frozen | R17-realmlp-recipe |
| R05-sequence | closed | 1 | TCN catastrophic LB and weak stable evidence | model_saturation |
| R06-m-residual | closed | 4 | all residual families are insufficient for the gate | insufficient |
...
| R11-scfi-z | frozen | 13 | 152+73Z is production asset; P10 RQ run invalid | R20-submissions |
| R12-geometry-signature | closed | 4 | M02/M03/M04 below gate; no extension | insufficient |
...
| R17-realmlp-recipe | candidate | 11 | ParamMish/PL/PBLD/schedreg/coslog4 are candidate components | R18-blsm |
| R18-blsm | active | 1 | G0 validates behavior latent existence; G1 pre-registered | R17-realmlp-recipe |
| R19-production-calibration | external | 1 | external lb142 and self-owned anchors separated | N/A |
| R20-submissions | frozen | 10 | submission ledger is evidence-only | N/A |
